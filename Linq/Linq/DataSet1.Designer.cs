...
namespace Linq {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class EnrollmentDataTable : global::System.Data.TypedTableBase<EnrollmentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EnrollmentRow AddEnrollmentRow(int sid, int cid, int obtainedmarks) {
        ...
        public partial class EnrollmentRow : global::System.Data.DataRow {
            ...
            public int sid {
                get {
                    return ((int)(this[this.tableEnrollment.sidColumn]));
                }
                set {
                    this[this.tableEnrollment.sidColumn] = value;
                }
            }
            ...
            public int cid {
                get {
                    return ((int)(this[this.tableEnrollment.cidColumn]));
                }
                set {
                    this[this.tableEnrollment.cidColumn] = value;
                }
            }
            ...
            public int obtainedmarks {
                get {
                    return ((int)(this[this.tableEnrollment.obtainedmarksColumn]));
                }
                set {
                    this[this.tableEnrollment.obtainedmarksColumn] = value;
                }
            }
        }
...
namespace Linq.DataSet1TableAdapters {
    ...
    public partial class EnrollmentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Enrollment] WHERE (([id] = @Original_id) AND ([sid] = @Origina" +
                "l_sid) AND ([cid] = @Original_cid) AND ([obtainedmarks] = @Original_obtainedmark" +
                "s))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Enrollment] ([sid], [cid], [obtainedmarks]) VALUES (@sid, @cid" +
                ", @obtainedmarks);\r\nSELECT id, sid, cid, obtainedmarks FROM Enrollment WHERE (id" +
                " = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Enrollment] SET [sid] = @sid, [cid] = @cid, [obtainedmarks] = @obtainedmarks WHERE (([id] = @Original_id) AND ([sid] = @Original_sid) AND ([cid] = @Original_cid) AND ([obtainedmarks] = @Original_obtainedmarks));
SELECT id, sid, cid, obtainedmarks FROM Enrollment WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Linq.Properties.Settings.Default.CMSConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, sid, cid, obtainedmarks FROM dbo.Enrollment";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT id, sid, cid, obtainedmarks FROM dbo.Enrollment";
        ...
        public virtual int Fill(DataSet1.EnrollmentDataTable dataTable) {
        ...
        public virtual DataSet1.EnrollmentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet1.EnrollmentDataTable dataTable = new DataSet1.EnrollmentDataTable();
        ...
        public virtual int FillBy(DataSet1.EnrollmentDataTable dataTable) {
        ...
        public virtual DataSet1.EnrollmentDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            DataSet1.EnrollmentDataTable dataTable = new DataSet1.EnrollmentDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet1.EnrollmentDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, int Original_sid, int Original_cid, int Original_obtainedmarks) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_obtainedmarks));
        ...
        public virtual int Insert(int sid, int cid, int obtainedmarks) {
        ...
        public virtual int Update(int sid, int cid, int obtainedmarks, int Original_id, int Original_sid, int Original_cid, int Original_obtainedmarks, int id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int sid, int cid, int obtainedmarks, int Original_id, int Original_sid, int Original_cid, int Original_obtainedmarks) {
            return this.Update(sid, cid, obtainedmarks, Original_id, Original_sid, Original_cid, Original_obtainedmarks, Original_id);
        }
    }
